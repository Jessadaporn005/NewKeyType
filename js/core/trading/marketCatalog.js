...
export const TRADING_ASSETS = Object.freeze([
  ...
  paperAsset({ id: 'XAU/USD', name: 'Gold Reference (PAXG/USDT Proxy)', market: 'xm', dataMode: 'BINANCE_PROXY_OR_SIMULATED', proxyDisclosure: 'PAXG/USDT token proxy; not an XM/XAU spot quote', basePrice: 2748.50, unit: 'oz', minTick: 0.05, digits: 2, leverageMax: 500, lotSize: 100, pipValue: 10, baseSpread: 0.22, spreadUnit: 'pts', binanceSymbol: 'PAXGUSDT' }),
  paperAsset({ id: 'EUR/USD', name: 'EUR/USD Reference Scenario', market: 'xm', dataMode: 'SIMULATED_ONLY', basePrice: 1.0845, unit: '€', minTick: 0.0001, digits: 4, leverageMax: 500, lotSize: 100000, pipValue: 10, baseSpread: 0.00012, spreadUnit: 'pips' }),
  paperAsset({ id: 'GBP/USD', name: 'GBP/USD Reference Scenario', market: 'xm', dataMode: 'SIMULATED_ONLY', basePrice: 1.2980, unit: '£', minTick: 0.0001, digits: 4, leverageMax: 500, lotSize: 100000, pipValue: 10, baseSpread: 0.00015, spreadUnit: 'pips' }),
  paperAsset({ id: 'USOIL', name: 'WTI Reference Scenario', market: 'xm', dataMode: 'SIMULATED_ONLY', basePrice: 71.40, unit: 'bbl', minTick: 0.01, digits: 2, leverageMax: 100, lotSize: 100, pipValue: 10, baseSpread: 0.035, spreadUnit: 'pts' })
]);
