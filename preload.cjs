...
contextBridge.exposeInMainWorld('cyberSystemAPI', {
  ...
  armMT5DemoCanary: (request) => ipcRenderer.invoke('cyber:mt5-demo-canary-arm', request),
  sendMT5DemoCanary: (armToken) => ipcRenderer.invoke('cyber:mt5-demo-canary-send', armToken),
  killMT5DemoCanary: () => ipcRenderer.invoke('cyber:mt5-demo-canary-kill'),
  getMT5DemoCanaryStatus: () => ipcRenderer.invoke('cyber:mt5-demo-canary-status'),
